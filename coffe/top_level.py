...
class TopLevelNGSPICE(TopLevel):

	'''
	def __init__(self,self):
 	    print(########################## NGSPICE SELECTED)
 	'''
	...
	def generate_sram_writelh_power_top_lp(self,name, sram_per_column, unselected_column_count):
	    ...
	    the_file.write("quit \n .endc \n * Input signal \n Vground ground 0 0 \n\n")
	    the_file.write("Vprecharge n_precharge ground PULSE (0.8 0 0 50p 50p 'precharge_max' 'ram_frequency')\n")
	    the_file.write("Vdatain n_data_in ground PULSE (0.8 0 0 0 0 'ram_frequency' ' 2 * ram_frequency')\n")
	...
	def generate_mtj_read_power_top_lp(self,name, mtj_per_column):
	    ...
	    the_file.write("quit \n .endc \n * Input signal \n Vground ground 0 0 \n\n")
	    the_file.write("Vprecharge n_precharge ground PULSE (0.8 0 0 50p 50p 'precharge_max' 'ram_frequency')\n")
	    the_file.write("Vprechargeb n_precharge_b ground PULSE (0 0.8 0 50p 50p 'precharge_max' 'ram_frequency')\n")
	    the_file.write("Vse1 n_se1 ground PULSE (0.8 0 0 50p 50p 'sa_se1' 'ram_frequency')\n")
	    the_file.write("Vse2 n_se2 ground PULSE (0.8 0 0 50p 50p 'sa_se2' 'ram_frequency')\n")
	    ...
	    the_file.write("V_readl vdd_readl ground 0.8\n\n")
	    the_file.write("V_readh vdd_readh ground 0.8\n\n")
	    ...
	    the_file.write(".MEASURE TRAN meas_avg_power_readl PARAM = '-(meas_current_readl/(4 * ram_frequency)) * 0.8'\n\n")

	    the_file.write(".MEASURE TRAN meas_current_readh  INTEG I(V_readh) FROM= 0ns TO='4 * ram_frequency'\n")
	    the_file.write(".MEASURE TRAN meas_avg_power_readh PARAM = '-(meas_current_readh/(4 * ram_frequency)) * 0.8'\n\n")
	...
	def generate_mtj_write_power_top_lp(self,name, mtj_per_column):
	    ...
	    the_file.write("* This allows us to measure powersna of a circuit under test without measuring the power of wave shaping and load circuitry.\n")
	    the_file.write("V_selected vdd_selected ground 0.8\n\n")
	    the_file.write("V_selectedh vdd_selectedh ground 0.8\n\n")
	    ...
	    the_file.write(".MEASURE TRAN meas_avg_power_selectedh PARAM = '-(meas_current_selectedh/(4 * ram_frequency)) * 0.8'\n\n")
	...
	def generate_mtj_charge(self,name, colsize):
	    ...
	    the_file.write("OPTIONS BRIEF=1\n\n")
	    the_file.write("quit \n .endc \n * Input signal \n Vground ground 0 0 \n\n")
	    the_file.write("VIN n_in_b ground PULSE (0 0.8 0 0 0 4n 8n)\n")
	    the_file.write("VINb n_in ground PULSE (0.8 0 0 0 0 4n 8n)\n")


	    the_file.write("* Power rail for the circuit under test.\n")
	    the_file.write("* This allows us to measure power of a circuit under test without measuring the power of wave shaping and load circuitry.\n")
	    the_file.write("V_charge vdd_charge ground 0.8\n\n")
	    ...
	    the_file.write("* Total delays\n")
	    the_file.write(".MEASURE TRAN meas_total_tfall TRIG V(n_in) VAL='0.8/2' FALL=1\n")
	...
	def generate_mtj_sa_top(self,name, colsize):
	    ...
	    the_file.write("OPTIONS BRIEF=1\n\n")
	    the_file.write("quit \n .endc \n * Input signal \n Vground ground 0 0 \n\n")
	    the_file.write("VIN n_in ground PULSE (0 0.8 'time_bl' 50p 50p 4n 8n)\n")

	    the_file.write("VINc n_inc_b ground PULSE (0 0.8 0 0 0 4n 8n)\n")
	    the_file.write("VINbc n_inc ground PULSE (0.8 0 0 0 0 4n 8n)\n")
	    ...
	    the_file.write("* Total delays\n")
	    the_file.write(".MEASURE TRAN meas_total_tfall TRIG V(n_in) VAL='0.8 * 0.1' RISE=1\n")
	    the_file.write("+    TARG V(n_hang_out) VAL='0.8 * 0.95' RISE=1\n")
	    #we are only measuring fall, so I just copy it down here for regularity
	    the_file.write(".MEASURE TRAN meas_total_trise TRIG V(n_in) VAL='0.8 * 0.1' RISE=1\n")
	    the_file.write("+    TARG V(n_hang_out) VAL='0.8 * 0.95' RISE=1 \n\n")
	...
	def generate_mtj_discharge(self,name, colsize):
	    ...
	    the_file.write("VINb n_in_b ground PULSE (0.8 0 0 0 0 4n 8n)\n")


	    the_file.write("* Power rail for the circuit under test.\n")
	    the_file.write("* This allows us to measure power of a circuit under test without measuring the power of wave shaping and load circuitry.\n")
	    the_file.write("V_discharge vdd_discharge ground 0.8\n\n")
	    ...
	    the_file.write("+    TARG V(n_bl_"+str(colsize2)+") VAL='0.01 * 0.8' FALL=1\n")
	    #we are only measuring fall, so I just copy it down here for regularity
	...
	def generate_wordline_driver_top_lp(self,name, sramcount, nandsize, smallrow, repeater):
	    ...
	    the_file.write("* Power rail for the circuit under test.\n")
	    the_file.write("* This allows us to measure power of a circuit under test without measuring the power of wave shaping and load circuitry.\n")
	    the_file.write("V_wordline vdd_wordline ground 0.8\n\n")
	    ...
	    the_file.write("********************************************************************************\n\n")
	    the_file.write("* inv_" + name + " delay\n")
	    the_file.write(".MEASURE TRAN meas_inv_nand"+str(nandsize)+"_wordline_driver_1_tfall TRIG V(n_1_1) VAL='0.8/2' RISE=1\n")
	    the_file.write("+    TARG V(Xwordline.n_1_1) VAL='0.8/2' FALL=1\n")
	    the_file.write(".MEASURE TRAN meas_inv_nand"+str(nandsize)+"_wordline_driver_1_trise TRIG V(n_1_1) VAL='0.8/2' FALL=1\n")
	    the_file.write("+    TARG V(Xwordline.n_1_1) VAL='0.8/2' RISE=1\n\n")

	    the_file.write("* inv_" + name + " delay\n")
	    the_file.write(".MEASURE TRAN meas_inv_wordline_driver_2_tfall TRIG V(n_1_1) VAL='0.8/2' FALL=1\n")
	    the_file.write("+    TARG V(Xwordline.n_1_2) VAL='0.8/2' FALL=1\n")
	    the_file.write(".MEASURE TRAN meas_inv_wordline_driver_2_trise TRIG V(n_1_1) VAL='0.8/2' RISE=1\n")
	    the_file.write("+    TARG V(Xwordline.n_1_2) VAL='0.8/2' RISE=1\n\n")

	    the_file.write("* inv_" + name + " delay\n")
	    the_file.write(".MEASURE TRAN meas_inv_wordline_driver_3_tfall TRIG V(n_1_1) VAL='0.8/2' RISE=1\n")
	    the_file.write("+    TARG V(Xwordline.n_1_3) VAL='0.8/2' FALL=1\n")
	    the_file.write(".MEASURE TRAN meas_inv_wordline_driver_3_trise TRIG V(n_1_1) VAL='0.8/2' FALL=1\n")
	    the_file.write("+    TARG V(Xwordline.n_1_3) VAL='0.8/2' RISE=1\n\n")

	    the_file.write("* inv_" + name + " delay\n")
	    the_file.write(".MEASURE TRAN meas_inv_wordline_driver_4_tfall TRIG V(n_1_1) VAL='0.8/2' FALL=1\n")
	    the_file.write("+    TARG V(n_1_"+str(sramcount+1)+") VAL='0.8 * 0.1' FALL=1\n")
	    the_file.write(".MEASURE TRAN meas_inv_wordline_driver_4_trise TRIG V(n_1_1) VAL='0.8/2' RISE=1\n")
	    the_file.write("+    TARG V(n_1_"+str(sramcount+1)+") VAL='0.8 * 0.9' RISE=1\n\n")
	...
	def generate_dedicated_driver_top (self,name, top_name, num_bufs):
		...
		try:
		    ...
		    top_file.write("* inv_"+ name +"_"+str(i)+" delay\n")
		    top_file.write(".MEASURE TRAN meas_inv_"+ name +"_"+str(i)+"_tfall TRIG V(n_1_1) VAL='0.8/2' RISE=1\n")
		    top_file.write("+    TARG V(n_1_"+str(2 * i)+") VAL='0.8/2' FALL=1\n")
		    top_file.write(".MEASURE TRAN meas_inv_"+ name +"_"+str(i)+"_trise TRIG V(n_1_1) VAL='0.8/2' FALL=1\n")
		    top_file.write("+    TARG V(n_1_"+str(2 * i)+") VAL='0.8/2' RISE=1\n\n")
		if i + 1 == num_bufs * 2:
		    try:
		        top_file.write("* inv_"+ name +"_"+str(i+1)+" delays\n")
		        top_file.write(".MEASURE TRAN meas_inv_"+ name +"_"+str(i+1)+"_tfall TRIG V(n_1_1) VAL='0.8/2' FALL=1\n")
		        top_file.write("+    TARG V(Xdriver.n_1_2) VAL='0.8/2' FALL=1\n")
		        top_file.write(".MEASURE TRAN meas_inv_"+ name +"_"+str(i+1)+"_trise TRIG V(n_1_1) VAL='0.8/2' RISE=1\n")
		        top_file.write("+    TARG V(Xdriver.n_1_2) VAL='0.8/2' RISE=1\n\n")
		    except:
		        top_file.write("* inv_"+ name +"_"+str(i+1)+" delays\n")
		        top_file.write(".MEASURE TRAN meas_inv_"+ name +"_"+str(i+1)+"_tfall TRIG V(n_1_1) VAL='0.8/2' FALL=1\n")
		        top_file.write("+    TARG V(n_1_2) VAL='0.8/2' FALL=1\n")
		    ...
		    try:
		        ...
		        top_file.write("* inv_"+ name +"_"+str(i+1)+" delays\n")
		        top_file.write(".MEASURE TRAN meas_inv_"+ name +"_"+str(i+1)+"_tfall TRIG V(n_1_1) VAL='0.8/2' FALL=1\n")
		        top_file.write("+    TARG V(n_1_"+str(2 * i + 2)+") VAL='0.8/2' FALL=1\n")
		        top_file.write(".MEASURE TRAN meas_inv_"+ name +"_"+str(i+1)+"_trise TRIG V(n_1_1) VAL='0.8/2' RISE=1\n")
		        top_file.write("+    TARG V(n_1_"+str(2 * i + 2)+") VAL='0.8/2' RISE=1\n\n")
	    top_file.write("* Total delays\n")
	    top_file.write(".MEASURE TRAN meas_total_tfall TRIG V(n_1_1) VAL='0.8/2' FALL=1\n")
	    top_file.write("+    TARG V(n_1_3) VAL='0.8/2' FALL=1\n")
	    top_file.write(".MEASURE TRAN meas_total_trise TRIG V(n_1_1) VAL='0.8/2' RISE=1\n")
