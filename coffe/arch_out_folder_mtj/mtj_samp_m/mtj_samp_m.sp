...
VIN n_in ground PULSE (0 0.8_lp 'time_bl' 50p 50p 4n 8n)
VINc n_inc_b ground PULSE (0 0.8_lp 0 0 0 4n 8n)
VINbc n_inc ground PULSE (0.8_lp 0 0 0 0 4n 8n)
...
* Total delays
.MEASURE TRAN meas_total_tfall TRIG V(n_in) VAL='0.8_lp * 0.1' RISE=1
+    TARG V(n_hang_out) VAL='0.8_lp * 0.95' RISE=1
.MEASURE TRAN meas_total_trise TRIG V(n_in) VAL='0.8_lp * 0.1' RISE=1
+    TARG V(n_hang_out) VAL='0.8_lp * 0.95' RISE=1 
...
Xprechargesa n_1_1 n_2_1 n_in ground n_hang_out vclmpmtj vrefmtj vdd_lp ground vdd_charge ground mtj_subcircuits_sa
Xinv4 n_hang_out n_hang_out3 vdd_lp ground inv_lp Wn = 180n Wp = 300
...
Xcs n_1_1 n_bl_0 n_inc n_inc_b vdd_lp ground mtj_subcircuits_cs
Xcs_ref n_2_1 n_br_0 n_inc n_inc_b vdd_lp ground mtj_subcircuits_cs
...
X2MTJ512 vdd_lp ground n_br_512 ground ground ground vdd_lp ground memory_cell_ref
.IC V(n_1_1) = 0 
.IC V(n_2_1) = 0 
