...
.MEASURE TRAN meas_inv_nand2_xconfigurabledecoder2ii_1_tfall TRIG V(n_1_1) VAL='0.8_lp/2' RISE=1
+    TARG V(Xsec.n_1_1) VAL='0.8_lp/2' FALL=1
.MEASURE TRAN meas_inv_nand2_xconfigurabledecoder2ii_1_trise TRIG V(n_1_1) VAL='0.8_lp/2' FALL=1
+    TARG V(Xsec.n_1_1) VAL='0.8_lp/2' RISE=1

* inv_xconfigurabledecoder2ii delay
.MEASURE TRAN meas_inv_xconfigurabledecoder2ii_2_tfall TRIG V(n_1_1) VAL='0.8_lp/2' FALL=1
+    TARG V(n_1_129) VAL='0.8_lp/2' FALL=1
.MEASURE TRAN meas_inv_xconfigurabledecoder2ii_2_trise TRIG V(n_1_1) VAL='0.8_lp/2' RISE=1
+    TARG V(n_1_129) VAL='0.8_lp/2' RISE=1
...
xconfigurabledecoderi n_in n_1_1 vdd_lp ground xconfigurabledecoderi
Xsec n_1_1 n_1_2 vdd_sec ground xconfigurabledecoder2ii
